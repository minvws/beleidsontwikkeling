...
Een van de belangrijkste pijlers van de Aanbestedingswet is het proportionaliteitsbeginsel. Dit beginsel houdt in dat de gestelde eisen aan de aanbesteding in redelijke verhouding staan tot het voorwerp van de opdracht en kritisch te reflecteren op de gekozen aanbestedingsstrategie. Referenties uitvragen als geschiktheidseis kunnen tot gevolg hebben dat nieuwe of kleine bedrijven niet in aanmerking komen voor de opdracht. Een nieuw bedrijf heeft geen referenties, een klein bedrijf nog geen grote klussen gedaan. Maar denk ook aan de hoogte van de aansprakelijkheid en de verzekering die een leverancier hiervoor heeft (kunnen) afsluiten. Hetzelfde geldt voor bepaalde selectiecriteria. In onderstaande hoofdstukken wordt er op deze aspecten verder ingegaan.
